...
sea_neighs_mage2 %>%
  ...
  labs(fill = "age")
```
No difference, still doesn't have the water
...
st_erase <- function(x, y) {
  st_difference(x, st_union(st_combine(y), by_feature = TRUE))
}
...
ny_water2 <- st_combine(ny_water)
ny_water3 <- st_union(ny_water2)
```
